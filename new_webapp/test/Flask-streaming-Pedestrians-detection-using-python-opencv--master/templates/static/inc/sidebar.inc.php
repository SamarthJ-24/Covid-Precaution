	...
	<div class='sidebar'>
		<div class='sidebar-area'> 
			...
			<ul class='sidebar-menu'>
				...
				<li><a href='http://localhost:5000/'><img class='sidebar-menu-icon' src='images/ic_group_work_white_24dp.png'  /> Face Recognition and Mask Detection</a></li>
				<li><a href='outbreaks.php'><img class='sidebar-menu-icon' src='images/ic_group_work_white_24dp.png'  /> Social Distancing Monitoring</a></li>
				<li><a href='hiv.php'><img class='sidebar-menu-icon' src='images/ic_error_outline_white_24dp.png'  /> Covid-19</a></li>
